...
import numpy as np
from datasets.config import sdd_labelmap
...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties):
    ...
    label_map = sdd_labelmap # mark for modified
    ...
    # Calculate APs for each class (except background), average_precisions stores APs of each class.
    ...
    for c in range(1, n_classes):
        ...
        # So far, none
        true_class_boxes_detected = torch.zeros((true_class_difficulties.size(0)), dtype=torch.bool).to(
        ...
        for d in range(n_class_detections):
            # get the coordinates and image number about the object we predicted
            ...
            if max_overlap.item() > 0.5:
                ...
                if not object_difficulties[ind]:    # mark here for modified
    ...
    rev_label_map = rev_sdd_labelmap # mark for modified
